...
const Frontend = ({ lines }) => {
  ...
  return (
    <div className="flex flex-col w-full h-[calc(100vh-3.5rem)] bg-bg-accent text-text border border-border">
      {/* Header */}
      ...
      <div className="flex-1 flex items-center justify-center">
        <div className="bg-bg border border-border rounded-lg w-[80%] h-[70%] shadow-xl overflow-hidden flex flex-col">
